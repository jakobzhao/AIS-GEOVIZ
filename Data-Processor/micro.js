...
export function getGeoDistance (long1, lat1, long2, lat2) {
  let eRidus = 6371
  let φ1 = deg2rad(lat1)
  let φ2 = deg2rad(lat2)
...
// return in rad
export function getBearing (long1, lat1, long2, lat2) {
  let φ1 = deg2rad(lat1)
  let φ2 = deg2rad(lat2)
  let Δλ = deg2rad(long2 - long1)
...
* */
export function getCrossTrackDistance (long1, lat1, long2, lat2, long3, lat3) {
  let eRidus = 6371
